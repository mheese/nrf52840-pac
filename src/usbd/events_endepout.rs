...
#[doc = "The whole EPOUT\\[n\\] buffer has been consumed. The RAM buffer can be accessed safely by software.\n\nValue on reset: 0"]
...
impl R {
    #[doc = "Bit 0 - The whole EPOUT\\[n\\] buffer has been consumed. The RAM buffer can be accessed safely by software."]
    #[inline(always)]
