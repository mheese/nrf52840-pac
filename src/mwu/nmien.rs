#[doc = "Reader of register NMIEN"]
pub type R = crate::R<u32, super::NMIEN>;
#[doc = "Writer for register NMIEN"]
pub type W = crate::W<u32, super::NMIEN>;
#[doc = "Register NMIEN `reset()`'s with value 0"]
impl crate::ResetValue for super::NMIEN {
    type Type = u32;
    #[inline(always)]
